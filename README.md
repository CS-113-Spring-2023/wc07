...
This WC requires you to prove set identities.
...
- knowledge of set builder notation
- the ability to read logical notation
- knowledge of common set operations
- to apply proof techniques for set equality
...
_Deadline_: 2359h on Sun, 26 Feb
